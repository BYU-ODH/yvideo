...
class Scola @Inject
  ...
  val sharedSecret = configuration.getString("scola.secret").getOrElse("SuperSecret")
  val parameterPrefix = configuration.getString("scola.prefix").getOrElse("scolalop")
